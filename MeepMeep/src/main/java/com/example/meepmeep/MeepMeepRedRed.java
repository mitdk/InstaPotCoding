...
public class MeepMeepRedRed {
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                .waitSeconds(2)
                //SPECI 2 PICKUP
                .lineToLinearHeading(new Pose2d(30, -56.8, Math.toRadians(0)))
                .waitSeconds(2)
                //SPECI 2
                ...
                .waitSeconds(5)
                //SPECI 3
                .lineToConstantHeading(new Vector2d(6, -33))
                .waitSeconds(2)
                //PARK
                .lineToLinearHeading(new Pose2d(56, -60.5, Math.toRadians(180)))
