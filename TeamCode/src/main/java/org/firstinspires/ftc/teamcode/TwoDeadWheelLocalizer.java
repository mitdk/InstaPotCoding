...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2532.614622777892; // y position of the parallel encoder (in tick units) 9
        public double perpXTicks = 3369.9645367393937; // x position of the perpendicular encoder (in tick units) 7.5
    }
