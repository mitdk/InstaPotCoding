...
//Right Red
                /* .followTrajectorySequence(drive ->
                        ...
                        .waitSeconds(0.7)
                        //Makes specimen touch the bar, brings bot closer
...
//Left Red
                ...
                drive.trajectorySequenceBuilder(new Pose2d(-10, -66, 0))
                        ...
                        .waitSeconds(2)
                        //goes to 2nd sample
                       .splineToLinearHeading(new Pose2d(-46.7, -25.8, Math.toRadians(180)), Math.toRadians(90))
                       //Intakes 2nd sample block
                       .waitSeconds(2)
                       //Travel to basket
                       ...
                       .waitSeconds(2)
                       //goes to 3rd sample
                       .splineToLinearHeading(new Pose2d(-56.7, -25.8, Math.toRadians(180)), Math.toRadians(90))
                       //Intakes 3rd sample block
                       .waitSeconds(2)
                       //Travel to basket
